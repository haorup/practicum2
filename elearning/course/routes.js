...
router.get('/api/courses', verifyToken, async (req, res) => {
  try {
...
router.get('/api/courses/instructor/:instructorId', verifyToken, async (req, res) => {
  try {
...
router.get('/api/users/:userId/courses', verifyToken, async (req, res) => {
  try {
...
// Get course by ID
router.get('/api/courses/:id', verifyToken, async (req, res) => {
  try {
...
router.post('/api/courses', verifyToken, isFacultyOrAdmin, async (req, res) => {
  try {
